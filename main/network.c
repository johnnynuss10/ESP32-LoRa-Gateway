...
extern const uint8_t private_pem_key_start[] asm("_binary_theprivate_pem_key_start");
extern const uint8_t private_pem_key_end[] asm("_binary_theprivate_pem_key_end");
